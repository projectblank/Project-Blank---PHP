 ...
 * @version   CVS: $Id: CodeSniffer.php,v 1.1 2010/08/30 13:54:24 alairjt@gmail.com Exp $
    ...
    public static function setConfigData($key, $value, $temp=false)
    {
        if ($temp === false) {
            ...
            if (is_file($configFile) === false) {
                $configFile = 'C:\Arquivos de programas\PHP\data/PHP_CodeSniffer/CodeSniffer.conf';
            }
