 ...
 * @version    CVS: $Id: Setup.inc.php,v 1.1.6.2 2012/02/01 13:45:14 alair.tavares Exp $
...
class phpDocumentor_setup
{
    ...
    function parseIni()
    {
        ...
        if ('@DATA-DIR@' != '@'.'DATA-DIR@')
        {
        	...
        	$file = $base2 . '/phpDocumentor.ini';
            $options = phpDocumentor_parse_ini_file($file, true);

            phpDocumentor_out("   (found in " . $file . ")...\n");
        }
